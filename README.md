...
https://i.ibb.co/rRwmwDfh/image.png
<h1 align="center">
...
|-------------------------------------|----------------------------------------------------------------|----------------|-------------|
| **Olivia Pérez - Propietaria de hogar** | Buscar electricistas certificados                             | Frecuentemente | Alta        |
...
| **Eduardo Gonzales - Dueño de oficina/PYME** | Buscar formas de reducir costos energéticos                  | Frecuentemente | Alta        |
...
| **Alejandro López - Proveedor de servicios eléctricos** | Buscar nuevos clientes o trabajos                          | Frecuentemente | Alta        |
...
| US-05 | Navegación sin errores | Como visitante, quiero navegar por la página web sin encontrar errores, para tener una experiencia fluida que me anime a registrarme. | 1 |
| US-06 | Navegación mediante Encabezado | Como usuario, quiero un menú de navegación claro en el encabezado, para acceder fácilmente a las diferentes secciones de la página. | 1 |
| US-07 | Visualización del Pie de página | Como visitante, quiero ver un pie de página organizado con accesos directos e información de contacto, para encontrar información adicional rápidamente. | 1 |
| US-19 | Mensajes de éxito retroalimentación de registro | Como usuario, quiero recibir mensajes claros y accesibles al completar el registro sobre éxito para entender fácilmente el resultado de mis acciones. | 1 |
| US-20 | Mensajes de error retroalimentación de registro | Como usuario, quiero recibir mensajes claros y accesibles al completar el registro sobre cualquier error a la hora de completar el formulario, para entender fácilmente el resultado de mis acciones y saber cómo proceder. | 1 |
| US-22 | Cierre de Sesión | Como usuario autenticado, quiero cerrar mi sesión de forma segura para proteger mi cuenta cuando termine de usar la aplicación. | 1 |
...
| US-50 | Bloquear Fechas y Horarios Específicos | Como técnico registrado, quiero bloquear fechas específicas (vacaciones, emergencias) o horarios puntuales (citas médicas, otros compromisos) en mi calendario, para evitar que el sistema me asigne trabajos durante esos períodos. | 5 |
...
| **Team Member (Last Name, First Name)** | **GitHub Username** | **Identity and Access Management Bounded Context** | **Profile and Preferences Bounded Context** | **Subscription and Payments Bounded Context** | **Analytics Bounded Context** |
|-----------------------------------------|---------------------|-------------------------------------------|---------------------------------------------------|-------------------------|--------------------------|
| Sánchez Manrique, Ludwing               | ItaloSanche         | L                                         | C                                                 |                         |                          |
| Aliaga Aguirre, Ethan Matías            | MatFragg            |                                           |                                                   | C                       | C                        |
| Olivera Barzola , Eric Marlon           | EricMOB-afk         |                                           |                                                   | C                       | L                        |
| Machado Bracamonte, Ivo Marcelo         | ivommb11            |                                           | L                                                 |                         |                          |
| Del Aguila Ayala, Ricardo               | Rexest01            |                                           |                                                   | L                       | C                        |
