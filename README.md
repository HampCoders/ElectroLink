...
| US-40 | Contacto desde la Landing Page | Como visitante con preguntas específicas, quiero poder contactar fácilmente con la empresa, para resolver mis dudas antes de registrarme. | Escenario #1: Acceso a la información de contacto Given que un visitante se encuentra en la landing page When se desplaza hasta el footer Then debería ver claramente la información de contacto And esta debería incluir: Email, Teléfono, Dirección física And los datos de contacto deberían ser actuales y funcionales Escenario #2: Envío de mensaje a través del formulario de contacto Given que un visitante se encuentra con una pregunta específica When se desplaza hasta la sección de contacto And completa el formulario con: Nombre, Email, Asunto, Mensaje And hace clic en "Enviar mensaje" Then debería ver una confirmación de que su mensaje ha sido enviado And recibir información sobre cuándo puede esperar una respuesta | 7 |
