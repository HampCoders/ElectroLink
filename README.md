...
| US-22 | Visualización de Calificaciones y Reseñas | Como usuario, quiero poder ver las calificaciones y reseñas dejadas por otros usuarios, para tomar decisiones informadas sobre qué servicios utilizar. | Escenario \#1: Vista general de calificaciones<br>Given que estoy viendo el perfil de un servicio<br>Then puedo ver su calificación promedio<br>And puedo ver un desglose por número de estrellas (cuántas reseñas de 5 estrellas, cuántas de 4, etc.)<br>And puedo ver el número total de reseñas<br><br>Escenario \#2: Lectura de reseñas detalladas<br>Given que estoy en la sección de reseñas de un servicio<br>When navego por la lista de reseñas<br>Then puedo leer los comentarios completos de cada usuario<br>And puedo ver la fecha en que se dejó cada reseña<br>And puedo ordenar las reseñas por fecha o calificación<br><br>Escenario \#3: Filtrado de reseñas<br>Given que estoy en la sección de reseñas<br>When selecciono un filtro específico (solo 5 estrellas, solo reseñas con fotos, etc.)<br>Then la lista de reseñas se actualiza para mostrar solo las que cumplen con el criterio<br>And puedo restablecer fácilmente los filtros para ver todas las reseñas | 7 |
| US-23 | Contratación de Servicios Eléctricos mediante Wizard | Como propietario de PyME, quiero contar con un proceso guiado paso a paso para contratar servicios eléctricos, para poder solucionar mis problemas de forma rápida y sin complicaciones. | Escenario \#1: Selección del tipo de problema eléctrico<br>Given que estoy en la sección de contratación de servicios<br>When inicio el proceso haciendo clic en "Contratar Servicio Eléctrico"<br>Then se me presenta un formulario tipo wizard con pasos secuenciales<br>And el primer paso me permite seleccionar el tipo de problema de una lista categorizada<br>And puedo añadir descripción detallada y fotos del problema<br><br>Escenario \#2: Elección de técnico disponible<br>Given que he seleccionado y descrito mi problema eléctrico<br>When avanzo al siguiente paso del wizard<br>Then veo una lista de técnicos disponibles para resolver mi problema<br>And puedo filtrar por valoración, precio y disponibilidad<br>And puedo ver el perfil completo de cada técnico antes de decidir<br><br>Escenario \#3: Selección de fecha y horario<br>Given que he seleccionado un técnico para mi servicio<br>When paso a la etapa de programación<br>Then puedo ver un calendario con las fechas y horarios disponibles<br>And puedo seleccionar la franja horaria que mejor se adapte a mi disponibilidad<br>And recibo recomendaciones de horarios con menor tarifa si aplica<br><br>Escenario \#4: Confirmación y pago del servicio<br>Given que he seleccionado problema, técnico y fecha<br>When llego al paso final del wizard<br>Then veo un resumen completo de mi solicitud con todos los detalles<br>And se me presenta un desglose de costos (visita técnica, materiales estimados, etc.)<br>And puedo seleccionar un método de pago<br>And al confirmar, recibo una confirmación por correo electrónico y en la aplicación | 4 |
| US-24 | Entrar a un dashboard Personalizado | Como usuario de la plataforma, quiero acceder a un dashboard personalizado al iniciar sesión, para visualizar de forma inmediata la información relevante según mi rol y actividad reciente. | Escenario \#1: Visualización del dashboard para cliente<br>Given que he iniciado sesión como cliente (propietario/PyME)<br>When accedo a la página principal<br>Then veo un resumen de mis servicios activos<br>And veo mis próximos mantenimientos programados<br>And veo notificaciones recientes y recordatorios<br>And veo recomendaciones personalizadas de servicios y guías<br><br>Escenario \#2: Visualización del dashboard para técnico/proveedor<br>Given que he iniciado sesión como proveedor<br>When accedo a la página principal<br>Then veo mi agenda de servicios del día<br>And veo las solicitudes pendientes que requieren mi atención<br>And veo un resumen de mis ingresos y estadísticas recientes<br>And veo mis calificaciones recientes y alertas importantes | 3 |
| US-25 | Centro de Notificaciones | Como usuario de la plataforma, quiero acceder a un centro centralizado de notificaciones, para estar al tanto de actualizaciones importantes y no perder información relevante. | Escenario \#1: Visualización de notificaciones no leídas<br>Given que he iniciado sesión en la plataforma<br>When hago clic en el icono de notificaciones<br>Then veo un listado de notificaciones recientes con las no leídas destacadas<br>And puedo ver la cantidad de notificaciones no leídas<br>And puedo marcar todas como leídas con un solo clic<br><br>Escenario \#2: Filtrado de notificaciones<br>Given que estoy en el centro de notificaciones<br>When selecciono un filtro específico (servicios, pagos, sistema)<br>Then las notificaciones se filtran según mi selección<br>And puedo buscar notificaciones específicas por palabra clave<br><br>Escenario \#3: Acciones desde notificaciones<br>Given que estoy viendo una notificación específica<br>When hago clic en ella<br>Then soy redirigido a la sección relacionada con la notificación<br>And puedo realizar acciones directas si la notificación lo requiere<br>And la notificación se marca automáticamente como leída | 3 |
| US-26 | Sistema de Soporte al Usuario | Como usuario de la plataforma, quiero acceder a un sistema de soporte integrado, para resolver dudas o problemas técnicos que pueda tener durante mi experiencia. | Escenario \#1: Consulta de base de conocimientos<br>Given que estoy en la sección "Soporte"<br>When busco en la base de conocimientos usando palabras clave<br>Then veo artículos y tutoriales relacionados con mi búsqueda<br>And puedo filtrar por categorías específicas<br>And puedo calificar la utilidad de los artículos consultados<br><br>Escenario \#2: Acceso a chat en vivo<br>Given que estoy en la sección "Soporte"<br>When el soporte en vivo está disponible según el horario indicado<br>Then puedo iniciar una conversación con un agente de soporte<br>And puedo compartir capturas de pantalla de mi problema<br>And recibo un registro de la conversación por correo electrónico al finalizar | 7 |
| US-27 | Gestión de Técnicos Favoritos | Como cliente, quiero poder marcar y gestionar una lista de técnicos favoritos, para contactarlos fácilmente para futuros servicios y dar preferencia a aquellos con los que he tenido buenas experiencias. | Escenario \#1: Añadir técnico a favoritos<br>Given que he recibido un servicio satisfactorio de un técnico<br>When visito su perfil profesional<br>And hago clic en "Añadir a favoritos"<br>Then el técnico se añade a mi lista de favoritos<br>And recibo confirmación de la acción<br><br>Escenario \#2: Visualización de lista de favoritos<br>Given que he marcado varios técnicos como favoritos<br>When accedo a la sección "Técnicos Favoritos"<br>Then veo un listado de todos mis técnicos favoritos<br>And puedo filtrarlos por especialidad<br>And veo su disponibilidad actual y datos de contacto<br><br>Escenario \#3: Contratación directa de favoritos<br>Given que estoy en mi lista de técnicos favoritos<br>When selecciono "Contratar servicio" en un técnico específico<br>Then se inicia el wizard de contratación con ese técnico preseleccionado<br>And puedo omitir el paso de selección de técnico<br>And el técnico recibe notificación prioritaria de mi solicitud | 3 |
| US-28 | Sistema de Recomendaciones Personalizadas | Como cliente, quiero recibir recomendaciones personalizadas de servicios y productos basados en mi historial y necesidades, para descubrir soluciones relevantes que puedan mejorar mi experiencia. | Escenario \#1: Visualización de recomendaciones en dashboard<br>Given que he iniciado sesión en mi cuenta<br>When accedo a la sección "Recomendaciones" en mi panel<br>Then veo sugerencias de servicios basados en mis contrataciones previas<br>And veo productos relacionados con mis instalaciones<br><br>Escenario \#2: Ajuste de preferencias de recomendación<br>Given que estoy en la sección de recomendaciones<br>When selecciono "Configurar preferencias"<br>Then puedo indicar qué tipos de recomendaciones deseo recibir<br>And puedo establecer un presupuesto máximo para recomendaciones<br>And mis preferencias se aplican a futuras sugerencias | 7 |
| US-29 | Gestión de Pagos y Facturación | Como cliente, quiero gestionar mis pagos y acceder a mi historial de facturación, para mantener control sobre mis gastos y tener la documentación necesaria para fines contables. | Escenario \#1: Visualización de facturas pendientes<br>Given que he iniciado sesión en mi cuenta<br>When accedo a la sección "Pagos"<br>Then veo un listado de facturas pendientes de pago<br>And puedo ver el detalle de cada factura<br>And puedo seleccionar varias facturas para pago conjunto<br><br>Escenario \#2: Descarga de comprobantes fiscales<br>Given que estoy en la sección "Pagos"<br>When selecciono una factura pagada<br>Then puedo descargar el comprobante fiscal (PDF)<br>And puedo solicitar el envío del comprobante por correo<br>And puedo ver el historial completo de facturas emitidas<br><br>Escenario \#3: Configuración de facturación automática<br>Given que estoy en la sección "Pagos"<br>When configuro "Facturación automática"<br>Then puedo establecer un método de pago predeterminado<br>And puedo activar el pago automático para servicios recurrentes<br>And recibo notificaciones previas antes de cada cargo | 7 |
| US-30 | Gestión de Agenda y Citas | Como técnico/proveedor, quiero poder gestionar mi agenda de servicios y citas, para organizar eficientemente mi trabajo y maximizar mi productividad. | Escenario \#1: Visualización de agenda diaria/semanal/mensual<br>Given que he iniciado sesión como proveedor<br>When accedo a "Agenda de Servicios"<br>Then puedo alternar entre vistas diaria, semanal y mensual<br>And veo claramente mis servicios programados con códigos de color<br>And puedo ver detalles rápidos al pasar el cursor sobre cada cita<br><br>Escenario \#2: Confirmación de citas pendientes<br>Given que tengo solicitudes de servicio pendientes<br>When accedo a mi panel de citas<br>Then puedo ver las solicitudes que requieren confirmación<br>And puedo aceptar, reprogramar o rechazar cada solicitud<br>And al tomar una acción, el cliente recibe notificación automática<br><br>Escenario \#3: Bloqueo de horarios no disponibles<br>Given que estoy en mi agenda de servicios<br>When selecciono "Bloquear horario"<br>Then puedo marcar franjas horarias como no disponibles<br>And puedo establecer motivos (personal, otro trabajo, descanso)<br>And estos horarios no aparecen como disponibles para los clientes<br><br>Escenario \#4: Gestión de tiempos de traslado<br>Given que estoy configurando mi agenda<br>When activo "Considerar tiempos de traslado"<br>Then el sistema calcula automáticamente tiempos entre servicios<br>And sugiere horarios factibles basados en ubicaciones geográficas<br>And me advierte de posibles conflictos por distancias excesivas | 6 |
| US-31 | Gestión de Planes y Suscripciones | Como proveedor, quiero poder gestionar mi plan de suscripción en la plataforma, para acceder a beneficios adicionales que me ayuden a crecer mi negocio. | Escenario \#1: Visualización de planes disponibles<br>Given que estoy en la sección "Mi Suscripción"<br>When selecciono "Ver planes disponibles"<br>Then veo una comparativa de todos los planes (gratuito y premium)<br>And puedo ver claramente los beneficios adicionales de cada plan<br>And veo el precio y período de facturación de cada opción<br><br>Escenario \#2: Actualización a plan premium<br>Given que tengo un plan gratuito<br>When selecciono actualizar a un plan premium<br>Then veo un resumen de los nuevos beneficios que obtendré<br>And puedo seleccionar un método de pago<br>And tras completar el pago, mi cuenta se actualiza inmediatamente<br>And recibo confirmación por correo electrónico<br><br>Escenario \#3: Gestión de facturación de suscripción<br>Given que tengo un plan de pago activo<br>When accedo a "Detalles de facturación"<br>Then puedo ver mi historial de pagos de suscripción<br>And puedo actualizar mi método de pago<br>And puedo descargar comprobantes fiscales de mis pagos<br><br>Escenario \#4: Cancelación o downgrade de plan<br>Given que tengo un plan premium activo<br>When selecciono "Cancelar" o "Cambiar plan"<br>Then veo información sobre cómo afectará a mis servicios<br>And se me muestra el período restante de beneficios premium<br>And puedo confirmar o cancelar la acción | 6 |
| US-32 | Gestión de Servicios Ofrecidos | Como proveedor, quiero poder gestionar mi catálogo de servicios ofrecidos, para mantenerlo actualizado y mostrar claramente a los clientes mi oferta y especialidades. | Escenario \#1: Creación de nuevo servicio<br>Given que estoy en la sección "Productos/Catálogo"<br>When selecciono "Añadir nuevo servicio"<br>Then puedo completar un formulario detallado (nombre, descripción, categoría)<br>And puedo establecer precios base o rangos de precio estimado<br>And puedo indicar materiales incluidos/no incluidos<br>And puedo subir fotos de trabajos anteriores como referencia<br><br>Escenario \#2: Edición de servicios existentes<br>Given que tengo servicios publicados<br>When selecciono un servicio específico para editar<br>Then puedo modificar cualquier aspecto del servicio<br>And los cambios se reflejan inmediatamente en mi perfil público<br>And los clientes con servicios pendientes reciben notificación si es relevante<br><br>Escenario \#3: Configuración de disponibilidad por servicio<br>Given que estoy editando mis servicios<br>When configuro "Disponibilidad específica"<br>Then puedo establecer horarios específicos para cada tipo de servicio<br>And puedo limitar el número de servicios de cada tipo por día/semana<br>And puedo establecer zonas geográficas de cobertura por servicio<br><br>Escenario \#4: Establecimiento de promociones temporales<br>Given que estoy en la gestión de servicios<br>When selecciono "Crear promoción"<br>Then puedo seleccionar servicios específicos para promocionar<br>And puedo establecer descuentos o beneficios adicionales<br>And puedo definir un período de validez para la promoción<br>And la promoción se destaca automáticamente en mi perfil | 6 |
| US-33 | Historial de Clientes Atendidos | Como proveedor, quiero acceder a un historial detallado de los clientes que he atendido, para dar seguimiento a relaciones profesionales y mejorar mi servicio basado en experiencias previas. | Escenario \#1: Visualización de historial de clientes<br>Given que he iniciado sesión como proveedor<br>When accedo a "Historial de Clientes"<br>Then veo un listado de todos los clientes que he atendido<br>And puedo filtrar por fecha, tipo de servicio o ubicación<br>And puedo buscar clientes específicos por nombre<br><br>Escenario \#2: Acceso a detalles de cliente específico<br>Given que estoy en el historial de clientes<br>When selecciono un cliente específico<br>Then accedo a su perfil detallado dentro de mi panel<br>And veo todos los servicios que le he proporcionado<br>And veo las calificaciones y comentarios que me ha dejado<br>And veo notas privadas que he guardado sobre este cliente<br><br>Escenario \#3: Seguimiento post-servicio<br>Given que he completado un servicio recientemente<br>When accedo al perfil del cliente correspondiente<br>Then puedo enviar un mensaje de seguimiento personalizado<br>And puedo ofrecer un descuento en su próximo servicio<br>And puedo programar un recordatorio para contactarlo en el futuro<br><br>Escenario \#4: Análisis de feedback de clientes<br>Given que estoy en la sección de historial de clientes<br>When selecciono "Análisis de feedback"<br>Then veo estadísticas sobre la satisfacción de mis clientes<br>And veo tendencias en comentarios positivos y negativos<br>And recibo sugerencias sobre áreas de mejora basadas en el feedback | 6 |
| US-34 | Crear Portafolio Digital con Evidencias de Trabajo | Como proveedor de servicios eléctricos, quiero crear un portafolio digital dentro de mi perfil que incluya fotos, descripciones y referencias de trabajos anteriores, para mostrar mi experiencia y generar mayor confianza en potenciales clientes. | Escenario \#1: Creación de nuevo trabajo en portafolio<br>Given que el proveedor ya tiene una cuenta activa en la plataforma<br>And ha iniciado sesión correctamente<br>When accede a la sección "Mi Portafolio" desde su perfil<br>And selecciona la opción "Agregar nuevo trabajo"<br>And sube una imagen, una descripción del trabajo y una referencia del cliente<br>Then el sistema debe guardar y mostrar el nuevo trabajo en su portafolio<br>And debe aparecer públicamente en su perfil visible para clientes<br>And el proveedor debe poder editar o eliminar esa publicación en cualquier momento<br><br>Escenario \#2: Organización de trabajos por categorías<br>Given que el proveedor tiene varios trabajos en su portafolio<br>When accede a la sección "Organizar Portafolio"<br>Then puede crear y asignar categorías a cada trabajo<br>And puede reordenar los trabajos dentro de cada categoría<br>And los clientes pueden filtrar su portafolio por estas categorías<br><br>Escenario \#3: Incorporación de testimonios de clientes<br>Given que el proveedor ha completado trabajos registrados en la plataforma<br>When selecciona "Solicitar testimonio" en un trabajo específico<br>Then el sistema envía una invitación al cliente para dejar un comentario<br>And el testimonio aprobado se integra automáticamente al portafolio<br>And aparece junto al trabajo correspondiente | 6 |
| US-35 | Publicar Servicios en Foros de Contratación Certificada | Como proveedor certificado, quiero poder publicar mis servicios en espacios o foros donde se busca contratar profesionales verificados, para aumentar mi visibilidad y conseguir nuevas oportunidades laborales. | Escenario \#1: Publicación de servicio en foro certificado<br>Given que el proveedor tiene una cuenta verificada y está autenticado en la plataforma<br>And ha completado su perfil incluyendo certificaciones y portafolio<br>When accede a la sección "Foros de oportunidades"<br>And selecciona la opción "Publicar servicio"<br>And completa el formulario con detalles del servicio, zona de atención y disponibilidad<br>Then su publicación debe aparecer en los foros visibles para usuarios que buscan contratar profesionales certificados<br>And el sistema debe mostrar una insignia que verifique su condición de proveedor validado<br>And debe poder editar o eliminar su publicación en cualquier momento<br><br>Escenario \#2: Respuesta a solicitudes de servicio<br>Given que el proveedor está navegando en el foro de oportunidades<br>When encuentra una solicitud de servicio compatible con su perfil<br>Then puede enviar una propuesta directamente al cliente<br>And puede incluir presupuesto estimado y disponibilidad<br>And el cliente recibe notificación de la propuesta con acceso al perfil verificado del proveedor<br><br>Escenario \#3: Gestión de visibilidad por zonas geográficas<br>Given que el proveedor está configurando su publicación<br>When define sus zonas de cobertura<br>Then su publicación solo aparece para clientes en esas zonas<br>And puede establecer tarifas diferenciadas por distancia<br>And puede actualizar estas zonas en cualquier momento | 6 |
| US-36 | Solicitar Inspección General Anual | Como propietario responsable, quiero poder pedir una inspección general de mis instalaciones eléctricas una vez al año, para prevenir riesgos, fallas y garantizar el buen estado de mi sistema eléctrico. | Escenario \#1: Solicitud de inspección preventiva<br>Given que el usuario tiene una cuenta activa como propietario<br>And ha registrado una dirección o espacio para inspección en su perfil<br>And no ha solicitado una inspección general en los últimos 10 meses<br>When accede a la sección de "Mantenimientos preventivos"<br>And selecciona la opción "Solicitar inspección general anual"<br>And confirma la dirección y disponibilidad para la visita<br>Then el sistema debe generar una orden de inspección preventiva<br>And debe asignar un proveedor certificado disponible para la zona y tipo de servicio<br>And mostrar la fecha y estado de la solicitud en el historial del usuario<br><br>Escenario \#2: Configuración de recordatorios de inspección<br>Given que el propietario ha tenido una inspección previa<br>When accede a su historial de inspecciones<br>Then puede configurar recordatorios automáticos para la próxima inspección anual<br>And puede seleccionar con cuánta anticipación desea ser notificado<br>And recibe notificaciones según su preferencia cuando se acerca la fecha recomendada<br><br>Escenario \#3: Visualización de historial de inspecciones<br>Given que el propietario ha realizado inspecciones anteriores<br>When accede a "Historial de inspecciones"<br>Then puede ver las fechas y resultados de inspecciones pasadas<br>And puede acceder a los informes completos de cada inspección<br>And puede comparar resultados entre diferentes periodos | 4 |
| US-37 | Registrar Consumo Eléctrico Mensual | Como usuario interesado en el control energético, quiero poder anotar manualmente mi consumo mensual de electricidad, para llevar un seguimiento y detectar posibles aumentos o ahorros en el tiempo. | Escenario \#1: Registro de consumo mensual<br>Given que el usuario ha iniciado sesión en su cuenta<br>And se encuentra en la sección de "Mi consumo eléctrico"<br>When selecciona el mes actual<br>And ingresa la cantidad de kWh consumidos según su medidor o factura<br>And presiona "Guardar"<br>Then el sistema debe almacenar ese dato en el historial mensual<br>And mostrar un gráfico con la evolución del consumo en los últimos meses<br>And sugerir consejos si hay un aumento significativo de consumo<br><br>Escenario \#2: Visualización de análisis comparativos<br>Given que el usuario ha registrado su consumo durante varios meses<br>When accede a la sección "Análisis de consumo"<br>Then puede ver comparativas mensuales, estacionales y anuales<br>And puede visualizar tendencias de consumo en diferentes formatos gráficos<br>And recibe información sobre patrones identificados en su consumo<br><br>Escenario \#3: Establecimiento de metas de consumo<br>Given que el usuario está en la sección de consumo eléctrico<br>When selecciona "Establecer meta mensual"<br>Then puede definir un objetivo de consumo máximo en kWh<br>And el sistema muestra su progreso hacia esa meta durante el mes<br>And recibe alertas cuando está por superar el límite establecido |  4 |
| US-38 | Visualización de Características y Beneficios | Como visitante de la landing page, quiero ver claramente las características y beneficios de la plataforma, para entender cómo puede ayudarme y decidir si registrarme. | Escenario \#1: Visualización de beneficios para propietarios<br>Given que un propietario potencial se encuentra visitando la landing page<br>When se desplaza hasta la sección "Resolvemos problemas reales"<br>Then deberá ver claramente los beneficios específicos para propietarios<br>And cada beneficio debería tener un ícono representativo<br>And una descripción breve y clara<br>And los beneficios deberían ser visibles sin necesidad de hacer clic en ningún elemento<br><br>Escenario \#2: Visualización de características principales<br>Given que un visitante se encuentra en la landing page<br>When se desplaza hasta la sección "Características principales"<br>Then debería ver al menos 6 características destacadas de la plataforma<br>And cada característica debería tener un título descriptivo<br>And una explicación concisa de su funcionamiento<br>And un ícono visual que represente la característica<br><br>Escenario \#3: Comparativa para proveedores y clientes<br>Given que un visitante indeciso se encuentra en la landing page<br>When navega a la sección "¿Qué ofrecemos?"<br>Then debería ver una clara comparativa de beneficios por tipo de usuario<br>And puede identificar fácilmente qué le ofrece la plataforma según su rol<br>And visualiza casos de uso relevantes para su situación |7 |
| US-39 | Visualización de Testimonios | Como visitante indeciso sobre la plataforma, quiero ver testimonios de usuarios reales, para aumentar mi confianza en el servicio antes de registrarme. | Escenario \#1: Visualización de testimonios diversos<br>Given que el visitante se encuentra en la landing page<br>When se desplaza hasta la sección "Lo que dicen nuestros usuarios"<br>Then debería ver al menos 3 testimonios diferentes<br>And cada testimonio debería mostrar: Nombre de usuario, tipo de usuario, calificación y comentario<br>And observará testimonios tanto de propietarios como de proveedores<br>And las calificaciones deberían ser visualmente claras (estrellas)<br><br>Escenario \#2: Navegación entre testimonios en dispositivos móviles<br>Given que el visitante se encuentra usando un dispositivo móvil<br>When accede a la sección de testimonios<br>Then podrá deslizar horizontalmente para ver todos los testimonios<br>And verá indicadores de paginación que muestren cuántos testimonios hay disponibles<br>And en qué testimonio se encuentra actualmente<br><br>Escenario \#3: Visualización de casos de éxito destacados<br>Given que el visitante está explorando la landing page<br>When navega hasta la sección "Casos de éxito"<br>Then puede ver ejemplos concretos de problemas resueltos a través de la plataforma<br>And cada caso incluye el problema inicial, la solución y los resultados obtenidos<br>And puede identificarse con situaciones similares a las que podría enfrentar |  7 |
| US-40 | Contacto desde la Landing Page | Como visitante con preguntas específicas, quiero poder contactar fácilmente con la empresa, para resolver mis dudas antes de registrarme. | Escenario \#1: Acceso a la información de contacto<br>Given que un visitante se encuentra en la landing page<br>When se desplaza hasta el footer<br>Then debería ver claramente la información de contacto<br>And esta debería incluir: Email, Teléfono, Dirección física<br>And los datos de contacto deberían ser actuales y funcionales<br><br>Escenario \#2: Envío de mensaje a través del formulario de contacto<br>Given que un visitante se encuentra con una pregunta específica<br>When se desplaza hasta la sección de contacto<br>And completa el formulario con: Nombre, Email, Asunto, Mensaje<br>And hace clic en "Enviar mensaje"<br>Then debería ver una confirmación de que su mensaje ha sido enviado<br>And recibir información sobre cuándo puede esperar una respuesta<br><br>Escenario \#3: Acceso a preguntas frecuentes<br>Given que el visitante busca respuestas rápidas<br>When accede a la sección "Preguntas frecuentes" desde el menú o footer<br>Then encuentra un listado organizado por categorías de las dudas más comunes
